				...
				<div class="topbar-menu-area">
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>
								<li class="menu-item lang-menu menu-item-has-children parent">
									<a title="English" href="#">
                                        <span class="img label-before"><img src="{{ asset('assets/images/lang-en.png') }}" alt="lang-en"></span>English<i class="fa fa-angle-down" aria-hidden="true"></i>
                                    </a>
                                        ...
                                        @if (Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
									            ...
									            <ul class="submenu curency">
													...
													<li class="menu-item menu-item-has-children parent">
														<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('user-logout').submit();">Logout</a>
													</li>
									            </ul>
								            </li>
                                        @else
							...
							<form id="user-logout" action="{{ route('logout') }}" method="post" class="hidden">
								@csrf
							</form>
						</div>
					</div>
